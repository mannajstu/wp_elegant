...
jQuery(document).ready(function ($) {
    ...
    //Google map
    $('.google-map').gMap({address: 'Fort Lauderdale, FL',
        panControl: true,
        zoomControl: true,
        zoomControlOptions: {
    ...
    $(".next").click(function () {
        ...
        var current = $('.project-container.slide-in');
        var nextUp = current.next('.project-container');

        if (nextUp.length === 0) {
            $('.project-container:first').addClass('slide-in');
            $('.project-container:last').removeClass('slide-in');
        } else {
    ...
    $(".prev").click(function () {
        var current = $('.project-container.slide-in');
        var prevUp = current.prev('.project-container');

        if (prevUp.length === 0) {
            $('.project-container:last').addClass('slide-in');
            $('.project-container:first').removeClass('slide-in');
        } else {
